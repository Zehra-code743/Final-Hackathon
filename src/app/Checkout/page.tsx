              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center">
                  ...
                  <label htmlFor="card" className="ml-4 flex gap-2 cursor-pointer">
                    <FaCcMastercard className="w-12 h-12 text-gray-800" /> {/* Add Mastercard icon */}
                    <FaCcVisa className="w-12 h-12 text-gray-800" /> {/* Add Visa icon */}
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="paypal" className="ml-4 flex gap-2 cursor-pointer">
                    <FaPaypal className="w-20 h-12 text-gray-800" /> {/* Add PayPal icon */}
                  </label>
                </div>
              </div>
