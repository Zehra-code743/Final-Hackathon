      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="border rounded-lg overflow-hidden shadow-md">
          <div className="relative">
            <img src="/image.png" alt="Library Stool Chair" className="w-full h-60 object-cover" />
        ...
        <div className="border rounded-lg overflow-hidden shadow-md">
          <div className="relative">
            <img src="/pinksofa.png" alt="Library Stool Chair" className="w-full h-60 object-cover" />
        ...
        {/* Product 3 */}
        <div className="border rounded-lg overflow-hidden shadow-md">
          <img src="/Frame.png" alt="Library Stool Chair" className="w-full h-60 object-cover" />
          <div className="p-4">
            <h3 className="text-lg font-medium mb-2">Library Stool Chair</h3>
            <p className="text-gray-700 font-semibold">$20</p>
          </div>
        ...
        {/* Product 4 */}
        <div className="border rounded-lg overflow-hidden shadow-md">
          <img src="/Image2.png" alt="Library Stool Chair" className="w-full h-60 object-cover" />
          <div className="p-4">
            <h3 className="text-lg font-medium mb-2">Library Stool Chair</h3>
            <p className="text-gray-700 font-semibold">$20</p>
          </div>
